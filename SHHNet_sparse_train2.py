...
parser.add_argument('--model', type=str, default="SHHNet2_1", help=' select a model for training')
parser.add_argument('--weights', type=str, default="results/exp1/SHHNet2_1_train1_results/best_model.pth")
...
parser.add_argument('--lrf', type=float, default=0.000005, help='end learning rate')
    ...
    for epoch in range(args.epochs):
        ...
        with tqdm(train_loader) as pbar:
            for i, (images, labels) in enumerate(pbar):
                ...
                final_logits, selection_probs, auxiliary_loss = model(images, labels)
